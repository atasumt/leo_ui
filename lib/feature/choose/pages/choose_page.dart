  ...
  final List<Map<String, String>> dataList = [
    {
      'index': '0',
      'url': 'key',
      'title': 'Bağlantı Anahtarı İle',
      'body': 'Basit ayarlara ilişkin küçük bir not eklenecek'
    },
    {
      'index': '1',
      'url': 'link',
      'title': 'Bağlantı Adresi İle',
      'body': 'Gelişmiş ayarlara ilişkin küçük bir not eklenecek'
    },
    {
      'index': '2',
      'url': 'qr',
      'title': 'QR Kod İle',
      'body': 'QR Kod ile girişi açıklayan küçük bir not eklenecek'
    },
  ];

...
class _$LoginResponseModelImpl implements _LoginResponseModel {
  ...
  @override
  String toString() {
    return 'LoginResponseModel(kind: $kind, localId: $localId, email: $email, displayName: $displayName, idToken: $idToken, registered: $registered, refreshToken: $refreshToken, expiresIn: $expiresIn)';
  }
...
abstract class _LoginResponseModel implements LoginResponseModel {
  factory _LoginResponseModel(
      ...
      final bool? registered,
      final String? refreshToken,
      final String? expiresIn}) = _$LoginResponseModelImpl;
